...
const PLAID_CLIENT_ID = require('../newCredentials.js').PLAID_CLIENT_ID
const PLAID_SECRET = require('../newCredentials.js').PLAID_SECRET
...
console.log(PLAID_PUBLIC_KEY, "KEEEEEY")
